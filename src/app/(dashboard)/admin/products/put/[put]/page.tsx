...
//           `${Product_API_Endpoint}/getid/${put}`
//         );
...
//         // setProductId(response.data.productLabel);
...
//     // if (imageDeleted) {
//     //   console.log("Image has been deleted. Form submission prevented.");
//     //   return;
//     // }
//     e.preventDefault();
//     setLoading1(true);
...
//                   <button className="absolute top-1 right-1 bg-1 h-10 w-10 flex items-center justify-center" onClick={DeleteImage}>X</button>
//                 </div>
//               )}
//               {/* {image ? (
//                 <img
...
const Page = () => {
  ...
  const deleteImage = async (publicId: File) => {
    try {
      ...
      await axios.delete(
        `${Product_API_Endpoint}/deleteImage?publicId=${publicId}`
      );
      setImage(null);
      setImageUrl(null);
      setStoreImage(null);
